...
class Lib {
	public static function setAlphaMin( h : h2d.Object , c : Float) {
	...
	public static function setAlpha( h : h2d.Object , c : Float) {
		h.traverse( function (sp) {
			if ( Std.is(sp, h2d.Drawable)) {
				var d : h2d.Drawable = cast sp;
				d.alpha = c;
	...
	public static function setAlphaMax( h : h2d.Object , c : Float) {
		h.traverse( function (sp) {
			if ( Std.is(sp, h2d.Drawable)) {
				var d : h2d.Drawable = cast sp;
