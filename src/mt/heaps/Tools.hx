...
class Tools {
	 ...
	 */
	public static function blur( spr : h2d.Object, ?method : BlurMethod, ?freezed = false) : BlurredBitmap {
	...
	public static function glow( spr : h2d.Object, ?col : Int = 0xFFd700, ?alpha = 1.0, ?freezed = false  ) : BlurredBitmap {
		col = col & 0xFFFFFF;
	 ...
	 */
	public static function unglow(spr:h2d.Object) : h2d.Object {
	...
	public static function putOnTop2D( a:h2d.Object, b:h2d.Object ) {
		if ( a == null ) return;
	...
	public static function replace( a:h2d.Object, b:h2d.Object ) {
		if ( a == null ) return;
