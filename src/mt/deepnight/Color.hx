...
class Color {
	...
	public static inline function interpolateR(from:UInt, to:UInt, r:Float) return MLib.round( MLib.lerp( from>>16, to>>16, r ) );
	public static inline function interpolateG(from:UInt, to:UInt, r:Float) return MLib.round( MLib.lerp( (from>>8)&0xFF, (to>>8)&0xFF, r ) );
	public static inline function interpolateB(from:UInt, to:UInt, r:Float) return MLib.round( MLib.lerp( from&0xFF, to&0xFF, r ) );
