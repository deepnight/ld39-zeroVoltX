...
class Lib {
	...
	*/
	...
	public static function ludumProtection(allowLocal:Bool, allowAir:Bool) : Bool {
		...
		return
			...
			allowLocal && url!=null && url.indexOf(s)>=0 && url.indexOf("fi"+"le"+":")>=0 ||
			allowAir && url.indexOf("app:/")==0;
	}
	#end
